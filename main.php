    ...
    <div id="mainContainer" class="">
               ...
               <section>
                    <div class="sectioncontent">
                        ...
                        <th><span>Cantidad Días</span></th><th><span>Acciones</span></th></tr>
                        ...
                        </td><td><span>Juan Ramirez</span></td><td><span>Black</span></td><td><span>Grande</span></td><td><span>3</span></td>
                        <td><button class="formButton" type="submit" >Aceptar</button><button class="formButton" type="submit" >Ver info Completa</button></td></tr>
                        <tr class="espacio"><td></td></tr>
                        ...
                        </td><td><span>Pedro Perez</span></td><td><span>Pluto</span></td><td><span>Mediano</span></td><td><span>5</span></td>
                        <td><button class="formButton" type="submit" >Aceptar</button><button class="formButton" type="submit" >Ver info Completa</button></td></tr>
                        <tr class="espacio"><td></td></tr>
                        ...
                        <td><span>Leo Jara</span></td><td><span>Cachito</span></td><td><span>Mediano</span></td><td><span>11</span></td>
                        <td><button class="formButton" type="submit" >Aceptar</button><button class="formButton" type="submit" >Ver info Completa</button></td></tr>
                        <tr class="espacio"><td></td></tr>
                        ...
                        <td><span>Marcelo Funes</span></td><td><span>Tomi</span></td><td><span>Chico</span></td><td><span>4</span></td><td>
                            <button class="formButton" type="submit" >Aceptar</button><button class="formButton" type="submit" >Ver info Completa</button></td></tr>
                        <tr class="espacio"><td></td></tr>
