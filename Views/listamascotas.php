    ...
    <div id="mainContainer" class="" style="width:70em;">
                ...
                <section style="width:50em; min-height:10em">
                    ...
                    <table>
                        ...
                        <tr> <th><span>Foto</span></th> <th><span>Nombre</span></th><th><span>Tamaño</span></th><th><span>Edad</span></th><th><span>Raza</span></th><th><span>Especie</span></th></tr>
                        ...
                        <?php foreach($MascotaList as $mascota) { ?>
                            ...
                            <td> <span> <?php echo ucwords($mascota->getTamano()); ?> </span> </td>  <td> <span> <?php echo $mascota->getEdad(); ?></span> </td> 
                            <td> <span> <?php echo ucwords($mascota->getRaza()); ?></span> </td>  <td> <span> <?php echo ucwords($mascota->getEspecie()); ?></span> </td>  <td> <button class="formButton" type="submit" >Ver Perfil</button></td><td> <button class="formButton" type="submit" >Eliminar</button></td></tr>
