                ...
                <section style="width:60em; min-height:10em">
                    ...
                    <table>
                        ...
                        <?php foreach($MascotaList as $mascota) { ?>
                            ...
                            <td><form id="" action="<?php echo FRONT_ROOT."Mascota/ShowProfile"?>" class="activo">
                            <input type="number" value="<?php echo $mascota->getId();?>" name="id_mascota" style="display:none">    
                            <button class="formButton" type="submit" >Ver Perfil</button></td></form>
                            
                            
                            <td><form id="" action="<?php echo FRONT_ROOT."Mascota/Remove"?>" class="activo">
                            <input type="number" value="<?php echo $mascota->getId();?>" name="id_mascota" style="display:none">
                            <button class="formButton" type="submit" >Eliminar</button></td></tr></form>
